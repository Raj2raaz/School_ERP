...
const Sidebar = () => {
  ...
  return (
    <div className="w-64 bg-gradient-to-b from-purple-500 via-indigo-400 to-blue-300 text-white shadow-lg flex flex-col h-screen">
      ...
      <ul className="space-y-6 mt-6 flex-grow list-none"> {/* Remove list-style here */}
        <li>
          <Link
            to="/admin/classes"
      ...
      <li className="mt-4 mb-6 mx-2"> {/* Pushes it to the bottom */}
      <hr className="border-gray-300 my-4" />
        <button
